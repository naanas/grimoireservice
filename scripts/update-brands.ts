...
function guessBrand(name: string): string {
    if (name.toLowerCase().startsWith('mobile legends')) return 'Mobile Legends';
    if (name.toLowerCase().includes('ragnarok')) return 'Ragnarok';
    if (name.toLowerCase().includes('marvel')) return 'Marvel';
    if (name.toLowerCase().includes('magic chess')) return 'Magic Chess';
    if (name.toLowerCase().includes('tom and jerry')) return 'Tom and Jerry';
...
async function main() {
    ...
    for (const cat of categories) {
        ...
        if (cat.name.includes('Mobile Legends')) brand = 'Mobile Legends';
        if (cat.name.includes('Ragnarok')) brand = 'Ragnarok';
        if (cat.name.includes('Marvel')) brand = 'Marvel';
        if (cat.name.includes('Magic Chess')) brand = 'Magic Chess';
        if (cat.name.toLowerCase().includes('tom and jerry')) brand = 'Tom and Jerry';
        if (cat.name.includes('League of Legends')) brand = 'League of Legends';
