 ...
 */
const normalizeChannel = (paymentMethod, channel) => {
 ...
 */
export const getAvailableChannels = async (gatewayName) => {
 ...
 */
export const forwardWebhookToDupay = async ({ gatewayName, rawPayload, signature, }) => {
