...
export const getDashboardStats = async (req, res) => {
    try {
        ...
        const [totalTransactions, todayTransactions, successTransactions, totalRevenue, pendingTransactions] = await Promise.all([
...
export const updateProductPrice = async (req, res) => {
    try {
        ...
        if (price_sell !== undefined)
            updateData.price_sell = Number(price_sell);
...
export const updateCategory = async (req, res) => {
    try {
        ...
        if (requiresZoneId !== undefined)
            updateData.requiresZoneId = Boolean(requiresZoneId);
        if (requiresServerId !== undefined)
            updateData.requiresServerId = Boolean(requiresServerId);
